...
The package ships with the `VixPHPCS` ruleset plus additional standalone sniffs you can enable manually. The default catalog includes lifecycle checks such as forbidding `return` statements inside constructors and destructors. See [docs/SNIFFS.md](docs/SNIFFS.md) for the full catalog, examples, and configurable parameters.
