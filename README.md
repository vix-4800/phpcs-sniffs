...
The package ships with the `VixPHPCS` ruleset plus additional standalone sniffs you can enable manually. The default ruleset includes various object-oriented checks alongside the other bundled rules. See [docs/SNIFFS.md](docs/SNIFFS.md) for the full catalog, examples, and configurable parameters.
