...
The package ships with the `VixPHPCS` ruleset plus additional standalone sniffs you can enable manually. See [docs/SNIFFS.md](docs/SNIFFS.md) for the full catalog, including rules such as `VixPHPCS.Operators.PreferBooleanCastOverDoubleNegation`, examples, and configurable parameters.
